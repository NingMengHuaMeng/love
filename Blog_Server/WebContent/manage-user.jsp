...
<%
	//判断有没有用户列表数据，如果没有这就转到  user.s?op=query
...
<section class="container-fluid">
  ...
  <div class="row">
    ...
    <h1 class="page-header">操作</h1>
        <ol class="breadcrumb">
          <li><a data-toggle="modal" data-target="#addUser"  id=a>增加用户</a></li>
        </ol>
...
<div class="modal fade" id="addUser" tabindex="-1" role="dialog" aria-labelledby="addUserModalLabel">
  <div class="modal-dialog" role="document" style="max-width:450px;">
    <form action="user.s" method="post" autocomplete="off" draggable="false">
      <input type="hidden" name="op" value="add"><!-- 隐藏字段 -->
        ...
        <div class="modal-body">
          <table class="table" style="margin-bottom:0px;">
            ...
            <tbody>
              ...
              <tr>
                <td wdith="20%">新密码:</td>
                <td width="80%"><input type="password" class="form-control" name="pwd" maxlength="12" autocomplete="off" /></td>
              </tr>
              <tr>
                <td wdith="20%">确认密码:</td>
                <td width="80%"><input type="password" class="form-control" name="repwd" maxlength="12" autocomplete="off" /></td>
              </tr>
            </tbody>
            <tfoot>
              <tr></tr>
